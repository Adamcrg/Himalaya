...
const Iconguanliyuan: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
Iconguanliyuan.defaultProps = {
  size: 18,
};

export default React.memo ? React.memo(Iconguanliyuan) : Iconguanliyuan;
