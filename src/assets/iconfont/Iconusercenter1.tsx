...
const Iconusercenter1: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
Iconusercenter1.defaultProps = {
  size: 18,
};

export default React.memo ? React.memo(Iconusercenter1) : Iconusercenter1;
