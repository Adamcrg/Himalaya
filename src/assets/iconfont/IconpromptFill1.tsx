...
const IconpromptFill1: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconpromptFill1.defaultProps = {
  size: 18,
};

export default React.memo ? React.memo(IconpromptFill1) : IconpromptFill1;
