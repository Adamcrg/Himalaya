...
const Iconzhongjianren: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
Iconzhongjianren.defaultProps = {
  size: 18,
};

export default React.memo ? React.memo(Iconzhongjianren) : Iconzhongjianren;
