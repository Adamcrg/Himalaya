...
const IconcartEmptyFill: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconcartEmptyFill.defaultProps = {
  size: 18,
};

export default React.memo ? React.memo(IconcartEmptyFill) : IconcartEmptyFill;
