...
const IconcartEmpty1: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconcartEmpty1.defaultProps = {
  size: 18,
};

export default React.memo ? React.memo(IconcartEmpty1) : IconcartEmpty1;
