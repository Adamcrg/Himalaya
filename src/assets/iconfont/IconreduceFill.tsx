...
const IconreduceFill: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconreduceFill.defaultProps = {
  size: 18,
};

export default React.memo ? React.memo(IconreduceFill) : IconreduceFill;
